...
var GATEWAY_ID= config.GATEWAY_ID;

// Multicast group details config, see https://www.thethingsindustries.com/docs/devices/multicast/
var MULTICAST_APP_ID= config.MULTICAST_APP_ID;
var MULTICAST_DEV_ID= config.MULTICAST_DEV_ID;
...
const devices = config.DEVICE_LIST;

// Script config
const CLASS_C_WAIT_S = config.CLASS_C_WAIT_S;
